...
word_invert_index {
    ...
    def find_aritcle(self,id,left,right):
        data =  self.db(self.db.corpus.corpus_id == id).select(self.db.corpus.content[left:right]).first()
    ...
    def save_aritcle(self,aritcle):        
        ...
        corpus_meta_data= {"name":aritcle["name"],"source":aritcle["source"],"type":aritcle["type"],"time":aritcle["time"],"struct":aritcle["struct"],"md5":aritcle["md5"]}
